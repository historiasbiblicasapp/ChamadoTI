...
const PublicTrackingPage = lazy(() => import('./pages/portal/PublicTrackingPage').then(m => ({ default: m.PublicTrackingPage })));
  ...
  return (
    <ErrorBoundary>
      <AuthProvider>
        ...
        <Route path="/acompanhar/:token" element={<SuspenseWrapper><PublicTrackingPage /></SuspenseWrapper>} />
