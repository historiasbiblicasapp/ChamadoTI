    ...
    <>
      ...
      <aside
        className={`
          ...
          ${collapsed ? 'w-16' : 'w-64'} bg-gray-900 border-r border-gray-800 flex flex-col transition-all duration-300
      ...
      >
        ...
        <div className="p-3 border-t border-gray-800">
          ...
          <button
            ...
            className="hidden md:flex w-full items-center justify-center gap-2 text-xs text-gray-500 hover:text-gray-300 py-2 rounded-lg hover:bg-gray-800/50 transition-all"
          >
